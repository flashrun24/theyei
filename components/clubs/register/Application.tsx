        ...
        <div id="yei-form" className="space-y-6 sm:px-6 lg:px-0 lg:col-span-9">
          <Formik
            ...
            onSubmit={(values, { setSubmitting, resetForm }) => {
              ...
              data.append(
                '_cc',
                'admin@theyei.org,williamchen@theyei.org,ashley@theyei.org,miriam@theyei.org,kavin@theyei.org,ian@theyei.org,expansion@theyei.org,henry@theyei.org,maria@theyei.org,matias@theyei.org,satya@theyei.org'
              )
              data.append(
                '_autoresponse',
